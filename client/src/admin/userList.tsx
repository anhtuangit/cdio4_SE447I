...
const UserList = () => {
    ...
    return (
        <div className="flex-col h-[100%] w-[100%]">
            ...
            {users.map((user) => (
                <div className="gap-2 flex m-2 h-[70px] w-full rounded-lg border-2 border-gray-400 hover:bg-gray-200">
                    ...
                    <div className="flex w-[30%] gap-6 justify-end items-center mr-4">
                        <a href={`/admin/users/${user._id}`} className=" flex gap-2 border-2 rounded-lg p-1 hover:scale-105 hover:bg-gray-200 border-gray-400">
                        ...
                        <a href="" className="flex gap-2 p-1 border-2 rounded-lg hover:scale-105 hover:bg-gray-200 border-gray-400">
                            {user.status === 'unlock' ?
                                ...
                                :
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 36 36"><path fill="currentColor" d="M12 25.14V28h2v-2.77a2.42 2.42 0 1 0-2-.09" className="clr-i-outline clr-i-outline-path-1" /><path fill="currentColor" d="M26 2a8.2 8.2 0 0 0-8 8.36V15H2v17a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V15h-4v-4.64A6.2 6.2 0 0 1 26 4a6.2 6.2 0 0 1 6 6.36v6.83a1 1 0 0 0 2 0v-6.83A8.2 8.2 0 0 0 26 2m-4 15v15H4V17Z" className="clr-i-outline clr-i-outline-path-2" /><path fill="none" d="M0 0h36v36H0z" /></svg>
                            }

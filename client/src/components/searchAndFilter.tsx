const SearchAndFilter = () => {
    return (
        <div className=" flex w-[100%] h-[100%] items-center">
            <a href="" className="active:scale-95 flex h-8 w-auto items-center justify-center p-2 gap-2 border hover:shadow-md hover:shadow-sky-500 m-2 rounded-lg bg-sky-600">
                <span> Cả nước</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M36 18L24 30L12 18" /></svg>
            </a>
            <input className="p-2 text-base w-[60%] h-[40%] bg-transparent border border-green-600 border-shadow:sm focus-within:outline-0 focus:shadow-md focus:shadow-green-500 rounded-md placeholder:text-white" type="text" placeholder="Tìm kiếm bất động sản " />

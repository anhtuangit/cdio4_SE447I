        ...
        <div className="flex-col text-white bg-gray-200">
            <div className="flex bg-sky-800 w-[100%] ">
                ...
                <div className="w-[30%] flex items-center h-20 justify-end gap-3 pr-4">
                    <button className="active:scale-95 hover:bg-sky-800 hover:scale-105 flex border-2 rounded-md gap-2 bg-blue-500 w-[30%]">
                    ...
                    <button className="hover:transition-colors duration-100 active:scale-95 ease-in-out hover:scale-105 hover:bg-red-900 flex border-2 rounded-md gap-2 bg-red-500 w-[30%]">
